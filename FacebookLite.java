// Arthur Sulian
// 11/14/17  Launch 1.0
// FacebookLite project
// Builds a pseudo facebook that can store and display user data

/*  Change Log

    11/14/17 Official Launch 1.0  **Party Flares** **Air Horns**
+   added file system. Profiles save on exit and load on launch.

    11/08/17 Beta 0.2
+   added try catch blocks to all integer inputs
+   added checks for blank inputs
+   added age range limit

    11/07/17 Beta 0.1
+   added menu
+/  renamed Driver.java to FacebookLite.java
+   added loop so only the user can exit from app
    
    11/03/17 Alpha 0.03
+   added Stack class
-   removed array management from Friends and Wall classes
+   added array management to stack class to be called on by friends and wall
+   added more test calls to Driver
+   added array printing to util class
    
    10/29/17 Alpha 0.02
+/  renamed printer class to Util class
+   implemented all classes with working code ~~ Executes
    
    10/19/17 Alpha 0.01
+   added driver class and main
+   added person class
